...
v. 0.0.9 -
  ...
  6) Обновлена документация в соответствии с пп. 1-5.
...
v. 0.0.8 - 2018.09.13
  ...
  4) Скрипты lock-crypsetup-* пытаются отмотировать все точки монтирования ФС
     контейнера, если необходимо.  Скрипты unlock-cryptsetup-* вызывают
