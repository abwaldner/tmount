...
v. 0.0.8 -
  ...
  4) Скрипты lock-crypsetup-* пытаются отмотировать ФС контейнера, если
     необходимо.  Скрипты unlock-cryptsetup-* вызывают команду
     монтирования, если в контейнере найдена ФС.
